    ...
    * {
    ...
    .cus_card {
        ...
        h2 {
            height: 60px;
            padding: 20px;
            background-color: #ffffff88 transparent;
            transition: background-color .7s .1s, color .7s .1s;
            color:#ffffff;
        }
        //父層被摸到要顯示字體背景
        &:hover h2{
        ...
        h2:nth-child(1):after {
            ...
            height: 2px;
            margin: 10px 0;
            background-color: #391a3a;//變長顏色變淡?????
            transition: width .7s .1s;
        }
        &:hover h2::after {
            width: 100%;
        }
